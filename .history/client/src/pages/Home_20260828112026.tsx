    ...
    <main className="ux-field-notes">
      ...
      <section id="home" className="hero-paper section-anchor">
        ...
        <div className="hero-actions">
          ...
          <a className="text-button" href="/manus-storage/Karthick_Professional_Resume_7a2513c6.pdf" download="Karthkraja_Velmurugan_Professional_Resume.pdf">Download resume <Download size={15} /></a>
        </div>
      </section>
