...
const projects: Project[] = [
  {
    ...
    group: "ai",
    image: "/client/public/karthick-project-ai_a63a8c66.webp",
    summary:
  ...
  },
  {
    ...
    group: "product",
    image: "/client/public/karthick-project-commerce_df563adb.jpg",
    summary:
  ...
  },
  {
    ...
    group: "product",
    image: "/manus-storage/karthick-project-social_641dd8d5.jpg",
    summary:
    ...
    <main className="ux-field-notes">
      ...
      <section id="home" className="hero-paper section-anchor">
        ...
        <div className="hero-portrait-block">
          ...
          <div className="hero-portrait"><img src="client/public/karthick-project-ai_a63a8c66.webp" alt="Karthickraja Velmurugan" /></div>
        ...
        <div className="hero-actions">
          ...
          <a className="text-button" href="/manus-storage/Karthick_Professional_Resume_7a2513c6.pdf" download="Karthickraja_Velmurugan_Professional_Resume.pdf">Download resume <Download size={15} /></a>
        </div>
      </section>
