    ...
    <main className="ux-field-notes">
      ...
      <section id="home" className="hero-paper section-anchor">
        ...
        <div className="hero-actions">
          ...
          <a className="text-button" href="/manus-storage/Karthick_Profssional_Resume_7a2513c6.pdf" download="client\public\Karthickraja_Design_Resume.pdf">Download resume <Download size={15} /></a>
        </div>
      </section>
