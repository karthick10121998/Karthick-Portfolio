    ...
    <main className="ux-field-notes">
      ...
      <section id="credentials" className="credentials-paper section-anchor">
        ...
        <div className="credentials-grid">
          ...
          <article className="language-column"><p className="eyebrow">Languages</p><div><strong>Tamil</strong><span>Native</span></div><div><strong>English</strong><span>Professional</span></div><a href="client\public\Karthickraja_Professional_Resume.pdf" download="Karthickraja_Velmurugan_Professional_Resume.pdf">Download professional résumé <Download size={15} /></a></article>
        </div>
      </section>
